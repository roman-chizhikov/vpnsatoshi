...
export interface IbcApplicationsInterchainAccountsControllerV1MsgRegisterInterchainAccountResponse {
  channel_id?: string;
  port_id?: string;
}

export interface IbcApplicationsInterchainAccountsControllerV1MsgSendTxResponse {
  /** @format uint64 */
  sequence?: string;
}
 ...
 */
export interface IbcApplicationsInterchainAccountsV1InterchainAccountPacketData {
  /**
...
* - TYPE_UNSPECIFIED: Default zero value enumeration
 - TYPE_EXECUTE_TX: Execute a transaction on an interchain accounts host chain
*/
export enum IbcApplicationsInterchainAccountsV1Type {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  ibcApplicationsInterchainAccountsControllerV1InterchainAccount = (
    owner: string,
    connectionId: string,
   ...
   */
  ibcApplicationsInterchainAccountsControllerV1Params = (params: RequestParams = {}) =>
    this.request<
      { params?: { controller_enabled?: boolean } },
