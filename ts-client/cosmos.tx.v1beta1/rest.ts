...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  cosmosTxV1Beta1TxDecode = (body: { tx_bytes?: string }, params: RequestParams = {}) =>
    this.request<
   ...
   */
  cosmosTxV1Beta1TxDecodeAmino = (body: { amino_binary?: string }, params: RequestParams = {}) =>
   ...
   */
  cosmosTxV1Beta1TxEncode = (body: CosmosTxV1Beta1TxEncodeRequest, params: RequestParams = {}) =>
   ...
   */
  cosmosTxV1Beta1TxEncodeAmino = (body: { amino_json?: string }, params: RequestParams = {}) =>
