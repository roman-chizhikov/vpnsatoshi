 ...
 */
export type CosmosNftV1Beta1MsgSendResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  cosmosNftV1Beta1Balance = (owner: string, classId: string, params: RequestParams = {}) =>
   ...
   */
  cosmosNftV1Beta1Class = (classId: string, params: RequestParams = {}) =>
    this.request<
      {
        class?: {
          id?: string;
 ...
 */
   ...
   */
  cosmosNftV1Beta1NFT = (classId: string, id: string, params: RequestParams = {}) =>
    this.request<
      { nft?: { class_id?: string; id?: string; uri?: string; uri_hash?: string; data?: { "@type"?: string } } },
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
   ...
   */
  cosmosNftV1Beta1Owner = (classId: string, id: string, params: RequestParams = {}) =>
   ...
   */
  cosmosNftV1Beta1Supply = (classId: string, params: RequestParams = {}) =>
    this.request<{ amount?: string }, { code?: number; message?: string; details?: { "@type"?: string }[] }>({
