...
*/
export interface CosmosGroupV1MemberRequest {
  /** address is the member's account address. */
  address?: string;
 ...
 */
export interface CosmosGroupV1MsgCreateGroupPolicyResponse {
 ...
 */
export interface CosmosGroupV1MsgCreateGroupResponse {
  /**
 ...
 */
export interface CosmosGroupV1MsgCreateGroupWithPolicyResponse {
  /**
 ...
 */
export interface CosmosGroupV1MsgExecResponse {
 ...
 */
export type CosmosGroupV1MsgLeaveGroupResponse = object;

/**
 * MsgSubmitProposalResponse is the Msg/SubmitProposal response type.
 */
export interface CosmosGroupV1MsgSubmitProposalResponse {
  /**
   * proposal is the unique ID of the proposal.
   * @format uint64
   */
 ...
 */
export type CosmosGroupV1MsgUpdateGroupAdminResponse = object;

/**
 * MsgUpdateGroupMembersResponse is the Msg/UpdateGroupMembers response type.
 */
export type CosmosGroupV1MsgUpdateGroupMembersResponse = object;

/**
 * MsgUpdateGroupMetadataResponse is the Msg/UpdateGroupMetadata response type.
 */
export type CosmosGroupV1MsgUpdateGroupMetadataResponse = object;

/**
 * MsgUpdateGroupPolicyAdminResponse is the Msg/UpdateGroupPolicyAdmin response type.
 */
export type CosmosGroupV1MsgUpdateGroupPolicyAdminResponse = object;

/**
 * MsgUpdateGroupPolicyDecisionPolicyResponse is the Msg/UpdateGroupPolicyDecisionPolicy response type.
 */
export type CosmosGroupV1MsgUpdateGroupPolicyDecisionPolicyResponse = object;

/**
 * MsgUpdateGroupPolicyMetadataResponse is the Msg/UpdateGroupPolicyMetadata response type.
 */
export type CosmosGroupV1MsgUpdateGroupPolicyMetadataResponse = object;

/**
 * MsgVoteResponse is the Msg/Vote response type.
 */
export type CosmosGroupV1MsgVoteResponse = object;

/**
 * MsgWithdrawProposalResponse is the Msg/WithdrawProposal response type.
 */
export type CosmosGroupV1MsgWithdrawProposalResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   */
  cosmosGroupV1GroupInfo = (groupId: string, params: RequestParams = {}) =>
    this.request<
      {
        info?: {
          id?: string;
   ...
   */
  cosmosGroupV1GroupPoliciesByAdmin = (
    admin: string,
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
   ...
   */
  cosmosGroupV1GroupPoliciesByGroup = (
    groupId: string,
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
   ...
   */
  cosmosGroupV1GroupPolicyInfo = (address: string, params: RequestParams = {}) =>
    this.request<
      {
        info?: {
          address?: string;
   ...
   */
  cosmosGroupV1Proposal = (proposalId: string, params: RequestParams = {}) =>
    this.request<
      {
        proposal?: {
          id?: string;
 ...
 */
  cosmosGroupV1TallyResult = (proposalId: string, params: RequestParams = {}) =>
    this.request<
      { tally?: { yes_count?: string; abstain_count?: string; no_count?: string; no_with_veto_count?: string } },
      { code?: number; message?: string; details?: { "@type"?: string }[] }
    >({
   ...
   */
  cosmosGroupV1ProposalsByGroupPolicy = (
    address: string,
    query?: {
      "pagination.key"?: string;
      "pagination.offset"?: string;
   ...
   */
  cosmosGroupV1VoteByProposalVoter = (proposalId: string, voter: string, params: RequestParams = {}) =>
    this.request<
      {
        vote?: {
          proposal_id?: string;
